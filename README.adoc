...
image::https://img.shields.io/maven-central/v/io.github.georgwittberger/extend-mdc.svg[Maven Central]
image::https://img.shields.io/github/issues/georgwittberger/extend-mdc.svg[Open Issues]
image::https://img.shields.io/github/license/georgwittberger/extend-mdc.svg[License]
